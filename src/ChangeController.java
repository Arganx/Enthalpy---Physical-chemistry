                        ...
                        if (start < finish) {
                            ...
                            if (changeMethod.getValue() == Change.rozklad_dowolny) {
                                if (varianceValue.getCharacters().length() > 0 && expectedValue.getCharacters().length() > 0) {
                                    ...
                                    changeTable.getItems().add(new ChangeData(Double.parseDouble(tempStart.getCharacters().toString()), Double.parseDouble(tempFinish.getCharacters().toString()), changeMethod.getValue(), value, expe, vari));
                                ...
                                if (w1.getCharacters().length() > 0 && w2.getCharacters().length() > 0 && intervalX1.getCharacters().length() > 0 && intervalX2.getCharacters().length() > 0) {
                                    ...
                                    if (stringList1.size() == stringList2.size()) {
                                        ...
                                        changeTable.getItems().add(new ChangeData(Double.parseDouble(tempStart.getCharacters().toString()), Double.parseDouble(tempFinish.getCharacters().toString()), changeMethod.getValue(), value, wsp1, wsp2, wsp1.size(), przedzialX1, przedzialX2));
                                        Stage stage = (Stage) accept.getScene().getWindow();
                                        stage.close();
                                    } else {
                                        Alert alert = new Alert(Alert.AlertType.WARNING);
                                ...
                                changeTable.getItems().add(new ChangeData(Double.parseDouble(tempStart.getCharacters().toString()), Double.parseDouble(tempFinish.getCharacters().toString()), changeMethod.getValue(), value));
                                Stage stage = (Stage) accept.getScene().getWindow();
                                stage.close();
                            }
